...
namespace implemented
{
    ...
    public:
        ...
        void MoveForward(float distance)
        {
            ...
            glm::vec3 dir = glm::normalize(glm::vec3(forward.x, 0, forward.z));     // folosim proiectia pe planul XZ a lui forward
        ...
        void TranslateRight(float distance)
        {
            ...
            glm::vec3 dir = glm::normalize(glm::vec3(right.x, 0.0f, right.z));  // proiectia pe planul XZ a lui right
            position += dir * distance;
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::mat4 RotateLocalOX = glm::rotate(glm::mat4(1.0f), angle, glm::normalize(right));
            forward = glm::normalize(glm::vec3(RotateLocalOX * glm::vec4(forward, 0)));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::mat4 RotateWorldOY = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0));      // folosim axa lumii
            forward = glm::normalize(glm::vec3(RotateWorldOY * glm::vec4(forward, 0)));
            right = glm::normalize(glm::vec3(RotateWorldOY * glm::vec4(right, 0)));
            up = glm::normalize(glm::cross(right, forward));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::mat4 RotateLocalOZ = glm::rotate(glm::mat4(1.0f), angle, glm::normalize(forward));
            right = glm::normalize(glm::vec3(RotateLocalOZ * glm::vec4(right, 0)));
            up = glm::normalize(glm::cross(right, forward));
        }
        ...
        void RotateThirdPerson_OX(float angle)
        {
            ...
            TranslateForward(distanceToTarget);      // 1. translatie
            RotateFirstPerson_OX(angle);             // 2. rotatie
            TranslateForward(-distanceToTarget);     // 3. translatie inapoi
        ...
        void RotateThirdPerson_OY(float angle)
        {
            ...
            // the OY axis.
            TranslateForward(distanceToTarget);      // 1. translatie
            RotateFirstPerson_OY(angle);             // 2. rotatie
            TranslateForward(-distanceToTarget);     // 3. translatie inapoi
        ...
        void RotateThirdPerson_OZ(float angle)
        {
            ...
            // the OZ axis.
            TranslateForward(distanceToTarget);      // 1. translatie
            RotateFirstPerson_OZ(angle);             // 2. rotatie
            TranslateForward(-distanceToTarget);     // 3. rtranslatie inapoi
        }
